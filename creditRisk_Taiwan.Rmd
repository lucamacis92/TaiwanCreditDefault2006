...
date: "December 2021"
email: matteo.bandiera328@edu.unito.it, samuele.fonio@edu.unito.it, luca.macis@edu.unito.it
output:
...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.dim=c(7,3), fig.align='center'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.dim=c(7,3.5), fig.align='center'}
...
names(df_test)<-c("Acc","Bal.Acc.","F1")
...
From the ROC plot we can see that also Lasso has good performances and, as we said, there is room for improvement. 
In conclusion, we remember that the Logistic and KNN are soft classifiers, so we are able to change the probability cutoff to improve performance handly.
